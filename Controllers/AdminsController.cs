...
namespace OnlineSweetShop.Controllers
{
    public class AdminsController : Controller 
    {
        ...
        public AdminsController(SweetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Admins != null ? 
                          ...
                          Problem("Entity set 'SweetContext.Admin'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SweetContext.Admin'  is null.");
            }
            var admin = await _context.Admins.FindAsync(id);
            if (admin != null)
            {
        ...
        public ActionResult Adminlogin(Admin a)
        {
            var res = (from t in _context.Admins
                       where t.username == a.username && t.password == a.password
                       select t).Count();
            if (res > 0)
            {
